<h3 class="text-base"><?php _e('Folge uns', BB_TEXT_DOMAIN); ?></h3>
<ul class="list-none flex gap-2 items-center" id="social-media-menu">
    <li>
        <a class="btn btn-ghost btn-icon-only" href="https://www.instagram.com/wikimedia_de/" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" preserveAspectRatio="xMidYMid meet"
    ...
    <li>
        <a class="btn btn-ghost btn-icon-only" href="https://twitter.com/WikimediaDE" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" preserveAspectRatio="xMidYMid meet"
                viewBox="0 0 1024 1024">
                <path fill="currentColor"
    ...
    <li>
        <a class="btn btn-ghost btn-icon-only" href="https://www.linkedin.com/company/wikimedia-deutschland-e-v-/"
            target="_blank">
